...
## Agenda
- Review of current governance proposals and discussions
- Provider Console funding proposal (AP32)
- Update on Akash Accelerate 2025 event
- Progress updates on market making and PIP02 reconciliation
- Open floor for community questions and feedback
...
### Proposal and Funding Updates
- Two proposals are currently live on-chain:
  - Community Activities (Q2)
  - Provider Console proposal (AP32)

- Program and Event proposals for Q2 have already passed. The quarterly structure helps adjust for token volatility and ensures any surplus or deficit is managed transparently across quarters.

- Scott reminded everyone that the market making proposal and reconciliation for PIP02 are still in progress. Historical data requests have been submitted to help quantify depth improvements and market impacts.

### Provider Console Proposal (AP32)
- Cheng explained that AP32 builds on the initial integration of Praetor with Akash.
- This phase focuses on improving usability for providers by including:
  - Deployment tools for new providers  
  - Real-time analytics and observability (uptime, earnings, machine health)  
- The updated console enables providers to join and manage nodes independently, minimizing the need for technical handholding by the core team.
- Open source progress can be tracked via GitHub (Akash Console repo with "provider console" tag).

### Akash Accelerate 2025
- Cheng shared updates on this year’s Akash Accelerate event:
  - Will be held in Brooklyn, New York, toward the end of June 2025.
  - Follows the model of hosting alongside major crypto events to attract broader attendance.
  - The event will feature reflections on milestones since the last Accelerate (e.g., APEs, GPUs onboarding, provider console).
  - Topics will include decentralized training and infrastructure in the context of AI and crypto.
  - The Akash team is actively curating speaker lineups and community showcases.

- Cheng encouraged community devs to continue contributing to projects like Chat API and AOS integrations, noting that many impactful projects have come from community-led efforts.

### Market Making Progress
- Scott reported:
  - Still working on finalizing reconciliations for PIP02 commitments and expenditures.
  - Request submitted to Overclock’s market data providers for historical order book depth.
  - While terms with market makers can’t be fully shared, the team will report on metrics and depth improvements where possible.
  - Despite market-wide volatility, added depth has made it easier to move in and out of positions with less slippage.

### Open Floor Discussion
- Scott opened the floor for questions or comments from attendees.
- No major questions were raised. Scott encouraged contributors to post follow-ups in Discord or tag SIG Economics with ideas or feedback.
- Appreciation was expressed for the community’s ongoing involvement in shaping Akash’s growth path.

## Action Items

- Scott Hewitson:
  - Finalize and post reconciled PIP02 dashboard
  - Share community-friendly reporting for market making progress
  - Monitor community proposals and provide timely updates

- Cheng Wang:
  - Engage with GitHub feedback on the provider console
  - Continue planning and speaker coordination for Akash Accelerate 2025
  - Support onboarding of developers and community contributions to new infrastructure projects

- Community Members:
  - Participate in voting for AP32 and community activities proposals
  - Submit bugs and feature suggestions for the provider console via GitHub
  - Consider attending or supporting Akash Accelerate 2025
  - Share ideas or feedback through Discord or SIG Economics discussions
